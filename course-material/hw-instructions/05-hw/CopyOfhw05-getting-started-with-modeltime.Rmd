...
```{r}
# Data
tidyquant::tq_get("^VIX",from="2020-01-01") %>% select(date,adjusted) %>% rename(value=adjusted)->vix
...
- Exponential Smoothing
- Linear Regression
- MARS (Multivariate Adaptive Regression Splines) a classical GAMS model
