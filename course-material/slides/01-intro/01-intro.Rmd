...
.large[
  - **Veronica Zhang**
  - yzhang107@qub.ac.uk
  - Studying for a PhD in capital regulation in chinese banking.
]
]
...
- Posit Cloud (200+ students concurrently)
...
.pull-right-wide[
.large[[**Posit Cloud**](https://Posit.cloud/) created to make it easy for professionals, hobbyists, trainers, teachers, and students to do, share, teach, and learn data science using R.]
]
...
.large[[https://sso.posit.cloud/q-rap](https://sso.posit.cloud/q-rap)]
 ...
 * Project Deadline 31st March
 * Computer based exam (after easter break)
...
The chakra comes from [remark.js](https://remarkjs.com), [**knitr**](http://yihui.name/knitr), and [R Quarto](https://quarto.org).
