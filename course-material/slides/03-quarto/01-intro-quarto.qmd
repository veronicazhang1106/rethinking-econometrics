...
##  {background-image="img/title-slide.png" background-position="left"}
...
-   Got to <https://slido.com> and use code: `#qms-toolkit`
-   Or use this direct link <https://app.sli.do/event/aTPPko2f7tZVGQcyCxe44J>
...
-   `r fa("square", "yellow")` = Tom isn't explaining it well enough or I need time
...
-   Use the <https://slido.com> with code for questions: `#qms-toolkit`
...
-   Use Q-Rap to create a new default Quarto document
...
::: {.column width="50%"}
![](img/polar-axis.png){width="650px"}
:::
:::
...
![](img/quarto-cli-help.png){width="1200px" fig-align="center" fig-alt="A screenshot of a Visual and Source Quarto document"}
